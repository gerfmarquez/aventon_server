    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            RideManager.i().confirmRide(
                    driver,
                    passenger,
                    //todo //wait until the ride is confirmed to send an OK Response Code to Driver and proceeds to go pickup passenger
                    null);
            //todo send another code in case ride fails to confirm (maybe somebody else took it first)
